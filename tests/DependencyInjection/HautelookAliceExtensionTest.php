...
class HautelookAliceExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testLoadDefaultConfigWithAllExtensionsDisabled()
    {
        ...
        $containerBuilderProphecy->setParameter('hautelook_alice.db_drivers.mongodb.bundle_fixtures_path', 'DataFixtures/ODM')->shouldBeCalled();
        $containerBuilderProphecy->setParameter('hautelook_alice.db_drivers.phpcr.bundle_fixtures_path', 'DataFixtures/PHPCR')->shouldBeCalled();
    ...
    private function getBaseDefaultContainerBuiderProphecy()
    {
        ...
        $containerBuilderProphecy
            ->setDefinition(
                ...
                HautelookAliceBundleArgument::definition('Hautelook\AliceBundle\Alice\DataFixtures\Loader')
            )
            ->shouldBeCalled()
        ;
        $containerBuilderProphecy
